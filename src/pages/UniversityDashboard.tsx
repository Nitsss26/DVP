...
import { LOCAL_STUDENTS_DATA } from "@/data/mockData";
...
export default function UniversityDashboard() {
    ...
    // 1. Student Stats
    const totalStudents = LOCAL_STUDENTS_DATA.length;
    const studentsByBranch = LOCAL_STUDENTS_DATA.reduce((acc, student) => {
        const branch = student.Details?.Profile?.BranchCode || "Unknown";
    ...
    // Use dummy data if store is empty for better visualization during demo
    ...
    const requestStatusData = [
        { name: 'Approved', value: requestStats.approved, color: '#22c55e' }, // green-500
        { name: 'Pending', value: requestStats.pending, color: '#eab308' },   // yellow-500
        { name: 'Rejected', value: requestStats.rejected, color: '#ef4444' }, // red-500
        { name: 'Concerns', value: requestStats.studentConcerns, color: '#a855f7' }, // purple-500
    ];
